...
const SETTINGS = {
  ...
  managedRoutines: [MANAGED_ROUTINE],
...
const PAGES = {
  pages: [
    ...
    { path: "wiki/projects/llm-wiki.md", title: "LLM Wiki plugin", pageType: "projects", backlinkCount: 6, sourceCount: 3, contentHash: "f1b2c3d4", updatedAt: "2026-05-01T17:30:00Z" },
...
`,
  ...
  pageType: "concepts",
  backlinks: ["wiki/areas/plugin-runtime.md", "wiki/concepts/origin-kind.md", "wiki/projects/llm-wiki.md"],
...
const OPERATIONS = {
  operations: [
    ...
    { id: "2940eeeeeeee", operationType: "lint", status: "done", hiddenIssueId: "ii-2940", hiddenIssueIdentifier: "PAP-OP-2940", hiddenIssueTitle: "Nightly wiki lint · 17 findings (2 critical)", hiddenIssueStatus: "done", projectId: "prj-llmw-7e1a", costCents: 4, warnings: [
      ...
      { severity: "backlink", message: "Missing reverse links: managed-resources.md → projects/llm-wiki.md" },
...
const DISTILLATION_RUNS = [
  {
    ...
    affectedPagePaths: ["wiki/projects/control-plane.md"],
  ...
  },
  {
    ...
    affectedPagePaths: ["wiki/projects/billing.md", "wiki/projects/billing/decisions.md"],
...
const DISTILLATION_PAGE_BINDINGS = [
  {
    ...
    pagePath: "wiki/projects/control-plane.md",
    projectId: "prj-control-plane",
    projectName: "Control plane",
    rootIssueId: null,
  ...
  {
    id: "bind-billing",
    pagePath: "wiki/projects/billing.md",
    projectId: "prj-billing",
    projectName: "Billing",
    rootIssueId: null,
      ...
      <div style={{ border: "1px solid var(--border, oklch(0.269 0 0))", borderRadius: 8, overflow: "hidden", background: "var(--card, oklch(0.205 0 0))" }}>
        {rows.map((issue) => (
          <div
            ...
            style={{
              display: "grid",
              gridTemplateColumns: "110px minmax(0, 1fr) 110px 90px",
              gap: 12,
              alignItems: "center",
              padding: "10px 12px",
          ...
          >
            ...
            <span style={{ minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{issue.title}</span>
            <span style={{ fontSize: 11, color: "var(--muted-foreground, oklch(0.708 0 0))" }}>{issue.operationType}</span>
            <span style={{ justifySelf: "end", fontSize: 11, border: "1px solid var(--border, oklch(0.269 0 0))", borderRadius: 999, padding: "2px 8px" }}>{issue.status}</span>
          </div>
        ))}
      </div>
    </div>
